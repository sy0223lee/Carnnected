...
class CarWash5 extends StatefulWidget {
  final String id;
  const CarWash5({Key? key, required this.id}) : super(key: key);

  @override
  State<CarWash5> createState() => _CarWash5State();
}

class _CarWash5State extends State<CarWash5> {
  late String id;
