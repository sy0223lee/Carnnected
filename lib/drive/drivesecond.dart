...
import 'dart:convert';
import 'package:mosigg/drive/driveconfirm.dart';

class Drivesecond extends StatefulWidget {
  ...
  const Drivesecond(
      ...
      : super(key: key);
  @override
  _DrivesecondState createState() => _DrivesecondState();
}
  ...
  void showLoadingIndicator() async {
    ...
    if(insertcheck == false || loadingcheck != "true"){
      ...
      Navigator.push(context,
        MaterialPageRoute(builder: (BuildContext context) => Driveconfirm(
