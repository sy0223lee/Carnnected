          ...
          return GestureDetector(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Divider(thickness: 2.0, color: Color(0xff001A5D), endIndent: 300.0),
                  SizedBox(height: 40.0),
                  Padding(
                    padding: EdgeInsets.only(left: 25.0),
                    child: text('모시깽이의', 24.0, FontWeight.w600, Colors.black)
                  ),
                  Padding(
                    padding: EdgeInsets.only(left: 25.0),
                    child: text('계정을 만들게요:)', 24.0, FontWeight.w600, Colors.black)
                  ),
                  SizedBox(height: 40.0),
                  Form(
                    child: Container(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              helperStyle: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w600, color: Color(0xffCBCBCB)),
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              elevation: 0.0,
                              padding: EdgeInsets.symmetric(vertical: 12.0, horizontal: 154.7)
                            ),
                          ),
                          (idExist==true) ? 
                              Center(child: Padding(
                                padding: const EdgeInsets.all(20.0),
                                child: Text('앗! 이미 존재하는 아이디예요!', style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.black)),
                              )) : SizedBox(height: 61.0),
                          SizedBox(height: 90.0),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Container(height: 1.0, width: 130.0, color: Color(0xffCBCBCB)),
                              TextButton(
                                onPressed: (){
                                  // 간편 회원가입 페이지로 이동
                                }, 
                                child: text('간편 회원가입', 14.0, FontWeight.w600, Color(0xffCBCBCB))
                              ),
                              Container(height: 1.0, width: 130.0, color: Color(0xffCBCBCB)),
                            ]
                          ),
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Image.asset('image/kakao.png', width: 25, height: 25),
                                  SizedBox(width: 5),
                                  text('카카오로 시작', 14.0, FontWeight.w600, Colors.black)
                                ],
                              )),
                          ),
                        ],
